...
var UploadService = /** @class */ (function () {
    ...
    UploadService.prototype.uploadImgForProduct = function (file, jwtPayload) {
        return __awaiter(this, void 0, void 0, function () {
            var uploader, imageFileName;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        uploader = jwtPayload.nickName;
                        if (!!file) return [3 /*break*/, 1];
                        throw new common_1.BadRequestException("사진을 업로드 할 수 없습니다. 사진을 제시해 주세요.");
                    case 1:
                        imageFileName = file.filename;
                        return [4 /*yield*/, this.uploadRepository.uploadImg({
