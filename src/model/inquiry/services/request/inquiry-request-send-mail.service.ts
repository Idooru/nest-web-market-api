...
import { SendMailToAdminDto } from "../../dto/request/send-mail.dto";
...
export class InquiryRequestSendMailService extends SendMailLogger {
  ...
  async sendMailToAdmin(sendMailToAdminDto: SendMailToAdminDto) {
    const { userId, productId } = sendMailToAdminDto;
